...
export type PromptKind = 'analyze' | 'compare' | 'improve' | 'skillpath' | 'persona' | 'company' | 'people' | 'ecosystem' | 'match-signals' | 'matchScore' | 'notes-summary' | 'coach-discovery' | 'coach-profile-analysis' | 'coach-resume-optimize' | 'coach-cover-letter' | 'coach-questions-recruiter' | 'coach-questions-hiring-manager' | 'coach-questions-peer-panel' | 'variant-extraction' | 'variant-extraction-resume' | 'variant-extraction-jd';
