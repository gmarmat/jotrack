...
export async function GET(req: NextRequest) {
  try {
    ...
    const validKinds: PromptKind[] = ['analyze', 'compare', 'improve', 'skillpath', 'persona', 'company', 'people', 'ecosystem', 'match-signals', 'matchScore', 'variant-extraction', 'variant-extraction-resume', 'variant-extraction-jd'];
